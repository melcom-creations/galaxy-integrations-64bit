...
|---|---|---|---|
|[melcom Galaxy Plugin Updater](melcom-galaxy_plugin_updater/README.md)|Keeps installed melcom GOG Galaxy plugins up to date and creates backups before updating.|Plugin users|[v0.1.2 ZIP](melcom-galaxy_plugin_updater/melcom-galaxy_plugin_updater-v0.1.2.zip)|
